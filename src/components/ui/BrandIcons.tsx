...
export function LinkedinIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM.5 8.75h8.9V23H.5V8.75Zm14.6-.2c-2.14 0-3.58 1.17-4.16 2.28h-.06V8.75H2.98V23h7.02v-7.35c0-1.94.37-3.82 2.77-3.82 2.37 0 2.4 2.22 2.4 3.95V23H22V14.4c0-4.06-.87-7.85-6.9-7.85Z" />
    </svg>
  );
}
